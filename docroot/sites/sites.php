...
$sites['tcworkspace.aewa.info'] = 'aewa';
$sites['workspace.aewa.local'] = 'aewa';

$sites['workspace.eurobats.org'] = 'eurobats';
$sites['workspace.eurobats.local'] = 'eurobats';

$sites['workspace.ascobans.org'] = 'ascobans';
$sites['workspace.ascobans.local'] = 'ascobans';

$sites['workspace.cms.int'] = 'cms';
$sites['workspace.cms.local'] = 'cms';
